...
__global__ void BoundaryEast()
{
   ...
   case 3:	// velosity
      Ux = 0.02f;
      Uy = 0.0f;
      RhoExit = (Atmosin[Nx - 1][y].fC + Atmosin[Nx - 1][y].fS + Atmosin[Nx - 1][y].fN + 2.0f * (Atmosin[Nx - 1][y].fE + Atmosin[Nx - 1][y].fSE + Atmosin[Nx - 1][y].fNE)) / (1.0f + Ux);
      break;
   case 4:	// open (rho)
      RhoExit = 1.0;
      Uy = 0.0;
      Ux = (Atmosin[Nx - 1][y].fC + Atmosin[Nx - 1][y].fS + Atmosin[Nx - 1][y].fN + 2.0f * (Atmosin[Nx - 1][y].fE + Atmosin[Nx - 1][y].fSE + Atmosin[Nx - 1][y].fNE)) / RhoExit - 1.0f;
      break;
   }
   Uy = 6.f * (Atmosin[Nx - 1][y].fN - Atmosin[Nx - 1][y].fS + Atmosin[Nx - 1][y].fNE - Atmosin[Nx - 1][y].fSE) / RhoExit / (5 - 3 * Ux);

   Atmosin[Nx - 1][y].fW = Atmosin[Nx - 1][y].fE - 2.0f / 3.0f * Ux * RhoExit;
   Atmosin[Nx - 1][y].fSW = Atmosin[Nx - 1][y].fNE - (Ux - Uy) / 6.0f * RhoExit;
   Atmosin[Nx - 1][y].fNW = Atmosin[Nx - 1][y].fSE - (Ux + Uy) / 6.0f * RhoExit;
}
...
__global__ void BoundaryWest()
{
   ...
   case 2:	// symmetry
      ...
      return;
   case 3:	// velosity
      Ux = (1.0f * y / Ny) * 0.05f; // velocity from 0 to 0.05
      RhoExit = (Atmosin[0][y].fC + Atmosin[0][y].fS + Atmosin[0][y].fN + 2.0f * (Atmosin[0][y].fW + Atmosin[0][y].fSW + Atmosin[0][y].fNW)) / (1.0f - Ux);
      break;
   case 4:	// open (rho)
      RhoExit = 1.0f;
      Uy = 0.0f;
      Ux = 1.0f - (Atmosin[0][y].fC + Atmosin[0][y].fS + Atmosin[0][y].fN + 2.0f * (Atmosin[0][y].fW + Atmosin[0][y].fSW + Atmosin[0][y].fNW)) / RhoExit;
      break;
   }
   Uy = 6.f * (Atmosin[0][y].fN - Atmosin[0][y].fS + Atmosin[0][y].fNW - Atmosin[0][y].fSW) / RhoExit / (5 + 3 * Ux);
   Atmosin[0][y].fE = Atmosin[0][y].fW + 2.0f / 3.0f * Ux * RhoExit;
   Atmosin[0][y].fNE = Atmosin[0][y].fSW + (Ux - Uy) / 6.0f * RhoExit;
   Atmosin[0][y].fSE = Atmosin[0][y].fNW + (Ux + Uy) / 6.0f * RhoExit;
}
...
__global__ void BoundarySouth()
{
   ...
   case 3:	// velosity
      Ux = 0.02f;
      Uy = 0.0f;
      RhoExit = (Atmosin[x][0].fC + Atmosin[x][0].fE + Atmosin[x][0].fW + 2.0f * (Atmosin[x][0].fS + Atmosin[x][0].fSW + Atmosin[x][0].fSE)) / (1.0f - Uy);
      break;
   case 4:	// open
      RhoExit = 1.0f;
      Uy = 0.0f;
      Uy = 1.0f - (Atmosin[x][0].fC + Atmosin[x][0].fE + Atmosin[x][0].fW + 2.0f * (Atmosin[x][0].fS + Atmosin[x][0].fSW + Atmosin[x][0].fSE)) / RhoExit;
      break;
   }
   Atmosin[x][0].fN = Atmosin[x][0].fS + 2.0f / 3.0f * Uy * RhoExit;
   Atmosin[x][0].fNW = Atmosin[x][0].fSE + 0.5f * (Atmosin[x][0].fE - Atmosin[x][0].fW) + Uy * RhoExit / 6.0f - 0.5f * Ux * RhoExit;
   Atmosin[x][0].fNE = Atmosin[x][0].fSW - 0.5f * (Atmosin[x][0].fE - Atmosin[x][0].fW) + Uy * RhoExit / 6.0f + 0.5f * Ux * RhoExit;
}
...
__global__ void BoundaryNord()
{
   ...
   case 3:	// velosity
      Ux = 0.05f;
      Uy = 0.0f;
      RhoExit = (Atmosin[x][Ny - 1].fC + Atmosin[x][Ny - 1].fE + Atmosin[x][Ny - 1].fW + 2.0f * (Atmosin[x][Ny - 1].fN + Atmosin[x][Ny - 1].fNW + Atmosin[x][Ny - 1].fNE)) / (1.0f + Uy);
      break;
   case 4:	// open (rho)
      RhoExit = 1.0f;
      Uy = 0.0f;
      Uy = -1.0f + (Atmosin[x][Ny - 1].fC + Atmosin[x][Ny - 1].fE + Atmosin[x][Ny - 1].fW + 2.0f * (Atmosin[x][Ny - 1].fN + Atmosin[x][Ny - 1].fNW + Atmosin[x][Ny - 1].fNE)) / RhoExit;
      break;
   }
   Atmosin[x][Ny - 1].fS = Atmosin[x][Ny - 1].fN - 2.0f / 3.0f * Uy * RhoExit;
   Atmosin[x][Ny - 1].fSW = Atmosin[x][Ny - 1].fNE - (Ux + Uy) / 6.0f * RhoExit;
   Atmosin[x][Ny - 1].fSE = Atmosin[x][Ny - 1].fNW + (Ux - Uy) / 6.0f * RhoExit;
}
#endif