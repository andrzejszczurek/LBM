...
__global__ void InitialAtmos(bool NewSim)
{
   ...
   Atmosin[x][y].fE = Atmoseq[x][y].fE;  
   Atmosin[x][y].fN = Atmoseq[x][y].fN;
   Atmosin[x][y].fS = Atmoseq[x][y].fS;  
   Atmosin[x][y].fW = Atmoseq[x][y].fW;
   Atmosin[x][y].fNE = Atmoseq[x][y].fNE; 
   Atmosin[x][y].fNW = Atmoseq[x][y].fNW;
   Atmosin[x][y].fSE = Atmoseq[x][y].fSE; 
   Atmosin[x][y].fSW = Atmoseq[x][y].fSW;
}
...
__global__ void EquiRelaxAtmos()
{
   ...
   AtmosVy[x][y] = (Atmosin[x][y].fN + Atmosin[x][y].fNW + Atmosin[x][y].fNE - Atmosin[x][y].fS - Atmosin[x][y].fSW - Atmosin[x][y].fSE) / AtmosRho[x][y] - gravMod;
...
__global__ void StreamingAtmos()
{
   ...
   if (x < Nx - 1) // EW
   {
      Atmosin[x][y].fW = Atmosout[x + 1][y].fW;
      Atmosin[x + 1][y].fE = Atmosout[x][y].fE;
   }
   if (y < Ny - 1) // NS
   {
      Atmosin[x][y].fS = Atmosout[x][y + 1].fS;
      Atmosin[x][y + 1].fN = Atmosout[x][y].fN;
   }
   if (x < Nx - 1 && y < Ny - 1) //D1
   {
      Atmosin[x][y].fSW = Atmosout[x + 1][y + 1].fSW;
      Atmosin[x + 1][y + 1].fNE = Atmosout[x][y].fNE;
   }
   if (x > 0 && y < Ny - 1) // D2
   {
      Atmosin[x][y].fSE = Atmosout[x - 1][y + 1].fSE;
      Atmosin[x - 1][y + 1].fNW = Atmosout[x][y].fNW;
   }

   if (x == 0 || x == Nx - 1 || y == 0 || y == Ny - 1) 
   {
      Atmosin[x][y].fE = Atmosout[x][y].fE;
      Atmosin[x][y].fNE = Atmosout[x][y].fNE;
      Atmosin[x][y].fSE = Atmosout[x][y].fSE;
      Atmosin[x][y].fW = Atmosout[x][y].fW;
      Atmosin[x][y].fSW = Atmosout[x][y].fSW;
      Atmosin[x][y].fNW = Atmosout[x][y].fNW;
      Atmosin[x][y].fN = Atmosout[x][y].fN;
      Atmosin[x][y].fS = Atmosout[x][y].fS;
   }
}
