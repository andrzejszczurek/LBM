...
// cell near obstacles: coordinates, configuration, orientation
struct Obst
{
    int x;
    int y; 
...
__global__ void Obstacles(int a_nob)
{
    ...
    case 1:	// 	f2=f1;	f6=f5; f7=f8
        switch (typ2) {
        case 1: // east wall
            Atmosin[x][y].fN = Atmosout[x][y - 1].fN;
        ...
        case 2: // west wall
            ...
            return;
        case 3: // nord wall
            Atmosin[x][y].fE = Atmosout[x - 1][y].fE;
    ...
    case 2: // f2=f1+f4-f3+4(f6-f8); f7=f6-f8+f5+(f4-f3)/2; // f2=f1; f7=f5;
        ...
        case 6:  // left nord wall
            Atmosin[x][y].fE = Atmosout[x - 1][y].fE;
            Atmosin[x][y].fN = Atmosout[x][y - 1].fN; Atmosin[x][y].fW = Atmosout[x + 1][y].fW;
        ...
        case 7:  // right south wall
            Atmosin[x][y].fE = Atmosout[x - 1][y].fE;
            Atmosin[x][y].fW = Atmosout[x + 1][y].fW; Atmosin[x][y].fS = Atmosout[x][y + 1].fS;
